...
const Descriptionedit = ({ stepper, type }) => {
  return (
    <Fragment>
      ...
      <Form onSubmit={e => e.preventDefault()}>
        ...
        <div className='d-flex justify-content-between'>
          ...
          {/* <Button color='success' className='btn-next' onClick={() => stepper.next()}>
            <span className='align-middle d-sm-inline-block d-none'>ثبت تغیرات</span>
            <ArrowRight size={14} className='align-middle ms-sm-25 ms-0'></ArrowRight>
          </Button> */}
          <Button color='success' className='btn-submit' onClick={() => alert(' تغیرات با موفقیت انجام شد')}>
            ثبت تغیرات
          </Button>
        </div>
      </Form>
