...
function NewsReplyComments({parentId}) {

    const { data } =useQuery("NewsReplyComments", () => {return http.get(`/News/GetRepliesComments?Id=${parentId}`)})
...
export default NewsReplyComments