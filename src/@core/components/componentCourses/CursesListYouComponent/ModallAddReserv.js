...
const ModallAddReserv = ({setIsOpenAddReserv}) => {
  ...
  return (
    <Card className='w-100 mt-3  '>
      <a className='customizer-close d-flex justify-content-end ' onClick={() => setIsOpenAddReserv(false) }>
            <X />
          </a>
      <CardHeader>
...
export default ModallAddReserv
