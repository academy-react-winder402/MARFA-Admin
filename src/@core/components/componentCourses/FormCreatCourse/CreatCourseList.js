                    ...
                    <Card>
                      ...
                      <CardBody>
                        <Row>
                          ...
                          <Col lg='6'  >
                            <Label className='form-label' for='TremId'>ترم</Label>
                            <Select
                              id='TremId'
                              name='TremId'
                              className='react-select'
                          ...
                          <Col lg='6'  >
                            <Label className='form-label' for='ClassId'>شماره کلاس</Label>
                            <Select
                              id='ClassId'
                              name='ClassId'
                              className='react-select'
                          ...
                          <Col lg='6'  >
                            <Label className='form-label' for='ClassId'>سطح دوره</Label>
                            <Select
                              id='CourseLvlId'
                              name='CourseLvlId'
                              className='react-select'
                          ...
                          <Col lg='6'  >
                            <Label className='form-label' for='TeacherId'>نام استاد</Label>
                            <Select
                              id='TeacherId'
                              name='TeacherId'                              
                              className='react-select'
                          ...
                          <Col lg='6' >
                            <Label className='form-label' for='CurrentCoursePaymentNumber'>هزینه دوره</Label>
                            <Input onChange={handleChange} value={values.Cost} type='text' name='Cost' id='Cost' placeholder='Cost' />
                          </Col>

                          <Col lg='6' >
                            <Label className='form-label' for='Image'>عکس دوره</Label>
                          ...
                          <Col lg='6' >
                            <Label className='form-label' for='ShortLink'>لینک ثبت نام</Label>
...
export default CreatCourseList;
// ** React Imports
